...
#ifndef SWIFTCHATTER_SWIFT_H
#define SWIFTCHATTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="swiftChatter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface ActiveChatsVC (SWIFT_EXTENSION(swiftChatter)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC12swiftChatter16ChatLogTableCell")
@interface ChatLogTableCell : UITableViewCell
...
SWIFT_CLASS("_TtC12swiftChatter18ChatUsersTableCell")
...
- (IBAction)sliderValue:(UISlider * _Nonnull)sender;
- (IBAction)submitNewChatt:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC12swiftChatter7LogInVC")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified InvalidLogIn;
- (void)viewDidLoad;
- (BOOL)textFieldShouldReturn:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12swiftChatter16MessageTableCell")
...
SWIFT_CLASS("_TtC12swiftChatter13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified Username;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified Password;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified InvalidEmail;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified EmptyFirstName;
